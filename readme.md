...
## Sample Jenkinsfile with Veracode Dynamic Test Steps

The sample Jenkinsfile shows how to launch Dynamic Analysis scans from a pipeline:
 - first stage does a git pull of the project to Jenkins workspace
